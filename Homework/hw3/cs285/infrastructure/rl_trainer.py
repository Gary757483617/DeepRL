...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        print("******{} Frames/s******".format(self.fps))
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            if self.logvideo or self.logmetrics:
                ...
                if isinstance(self.agent, DQNAgent):
                    self.perform_dqn_logging(itr, paths, eval_policy, all_logs)
                else:
    ...
    ####################################
    ####################################
    def perform_dqn_logging(self, itr, paths, eval_policy, all_logs):
        last_log = all_logs[-1]
...
#             eval_video_paths = utils.sample_n_trajectories(self.env, eval_policy, MAX_NVIDEO, 
#                                                            MAX_VIDEO_LEN, True)
        ...
        if self.logvideo and train_video_paths != None:
            ...
            self.logger.log_paths_as_videos(eval_video_paths, itr, fps=self.fps,
                                            max_videos_to_save=MAX_NVIDEO,
                                             video_title='eval_rollouts_{}'.format(itr))
